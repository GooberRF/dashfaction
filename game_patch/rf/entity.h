...
namespace rf
{
    ...
    enum EntityState
    {
        ENTITY_STATE_STAND = 0x0,
        ENTITY_STATE_ATTACK_STAND = 0x1,
        ENTITY_STATE_WALK = 0x2,
        ENTITY_STATE_ATTACK_WALK = 0x3,
        ENTITY_STATE_RUN = 0x4,
        ENTITY_STATE_ATTACK_RUN = 0x5,
        ENTITY_STATE_FLEE_RUN = 0x6,
        ENTITY_STATE_FLAIL_RUN = 0x7,
        ENTITY_STATE_CROUCH = 0x8,
        ENTITY_STATE_ATTACK_CROUCH = 0x9,
        ENTITY_STATE_ATTACK_CROUCH_WALK = 0xA,
        ENTITY_STATE_ATTACK_LEAN_LEFT = 0xB,
        ENTITY_STATE_ATTACK_LEAN_RIGHT = 0xC,
        ENTITY_STATE_COWER = 0xD,
        ENTITY_STATE_FREEFALL = 0xE,
        ENTITY_STATE_ON_TURRET = 0xF,
        ENTITY_STATE_CORPSE_CARRY_STAND = 0x10,
        ENTITY_STATE_CORPSE_CARRY_WALK = 0x11,
        ENTITY_STATE_SWIM_STAND = 0x12,
        ENTITY_STATE_SWIM_WALK = 0x13,
